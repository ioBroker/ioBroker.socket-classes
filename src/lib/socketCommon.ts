...
export class SocketCommon {
    ...
    #reauthenticateRequested = new WeakMap<object, number>();
     ...
     */
    #disconnectSocket(socket: WebSocketClient): void {
        const transportSocket = socket as unknown as { disconnect?: (close?: boolean) => void; close?: () => void };

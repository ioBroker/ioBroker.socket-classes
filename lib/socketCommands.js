...
var _SocketCommands_instances, _SocketCommands_rename, _SocketCommands_unlink, _SocketCommands_subscribeStates, _SocketCommands_unsubscribeStates, _SocketCommands_subscribeFiles, _SocketCommands_fixAdminUI, _SocketCommands_httpGet;
                        ...
                        this.adapter.getObjectView('system', 'instance', {
                            ...
                            if (error) {
                                ...
                                callback(null, doc === null || doc === void 0 ? void 0 : doc.rows.map(item => {
                                    ...
                                    __classPrivateFieldGet(this, _SocketCommands_instances, "m", _SocketCommands_fixAdminUI).call(this, obj);
                                    return obj;
                                }).filter(obj => obj &&
            ...
            if (this._checkPermissions(socket, 'getObject', callback, id)) {
                try {
                    this.adapter.getForeignObject(id, { user: socket._acl.user }, (error, obj) => {
                        ...
                        if (this.adapter._language && id === 'system.config' && (obj === null || obj === void 0 ? void 0 : obj.common)) {
                            // @ts-expect-error adapter could have _language attribute
                            obj.common.language = this.adapter._language;
                        }
                ...
                try {
                    if (typeof callback === 'function') {
                        this.adapter.getForeignObjects('*', 'state', 'rooms', { user: socket._acl.user }, async (error, states) => {
                            ...
                            // overload language
                            // @ts-expect-error adapter could have _language attribute
                            if (this.adapter._language && ((_a = result['system.config']) === null || _a === void 0 ? void 0 : _a.common)) {
                                // @ts-expect-error adapter could have _language attribute
...
}, _SocketCommands_fixAdminUI = function _SocketCommands_fixAdminUI(obj) {
